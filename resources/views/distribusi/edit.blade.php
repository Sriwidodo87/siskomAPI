                    ...
                    @endif
                        ...
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <input type="text" name="nomer_surat" id="nomer_surat" class="form-control" value="{{$Distribusi->nomer_surat}}">
                            </div>
                            @error('nomer_surat')
                            ...
                            <div class="form-group col-12 ">
                                <label>Alasan</label>
                                <textarea type="text" name="alasan" id="alasan" class="form-control text-uppercase text-left"  >
                                    {{$Distribusi->alasan}}
                                </textarea>
                            </div>
                            @error('alasan')
